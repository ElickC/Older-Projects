...
int main(int argc, char * argv[])
{
	...
	int	mant_s1, mant_s2, mant_res, exp_s1, exp_s2, exp_fin = 0;
	int k = 0, shift_count = 0;
	...
	the_hardware_result = (float_32_s1.floating_value_in_32_bits
							+ float_32_s2.floating_value_in_32_bits);
	...
	float_32_rslt.f_bits.exponent = exp_fin;
	...
	printf("EMULATED FLOATING RESULT FROM PRINTF ==>>> %f", float_32_rslt.floating_value_in_32_bits);
